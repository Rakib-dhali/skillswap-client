  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center p-4 font-sans select-none">
      <div className="bg-white border border-black/10 w-full max-w-115 p-8 md:p-12 shadow-sm">
        ...
        <form onSubmit={handleSignIn} className="space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-baseline">
              ...
              <button
                type="button"
                className="text-[9px] font-bold tracking-wider text-black/50 uppercase hover:text-black cursor-pointer"
              >
                Forgot?
              </button>
            </div>
        ...
        <button onClick={googleAuth} className="w-full border border-black text-black bg-white py-3 text-xs font-bold tracking-[0.15em] uppercase hover:bg-black/5 transition-all flex items-center justify-center gap-2 cursor-pointer">
